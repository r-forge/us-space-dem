...
.onAttach <- function(libname, pkgname){
  	temp<-packageDescription("UScensus2000")
  ...
  msg<-paste(msg,'For citation information, type citation("UScensus2000").\n')
  msg<-paste(msg,'Type help(package="UScensus2000") to get started.\n')
