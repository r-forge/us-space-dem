...
.onAttach <- function(libname, pkgname){
  	temp<-packageDescription("UScensus2000tract")
  ...
  msg<-paste(msg,'For citation information, type citation("UScensus2000tract").\n')
  msg<-paste(msg,'Type help(package="UScensus2000tract") to get started.\n')
