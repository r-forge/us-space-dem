...
.onAttach <- function(libname, pkgname){
  	temp<-packageDescription("UScensus2000cdp")
  ...
  msg<-paste(msg,'For citation information, type citation("UScensus2000cdp").\n')
  msg<-paste(msg,'Type help(package="UScensus2000cdp") to get started.\n')
