...
.onAttach <- function(libname, pkgname){
  	temp<-packageDescription("UScensus2000blkgrp")
  	msg<-paste(temp$Package,": ",temp$Title,"\n",
      "Version ",temp$Version,
      " created on ",
      temp$Date,".\n", sep="")
  msg<-paste(msg,"copyright (c) 2013, Zack W. Almquist, University of Minnesota\n",sep="")

  msg<-paste(msg,'For citation information, type citation("UScensus2000blkgrp").\n')
  msg<-paste(msg,'Type help(package="UScensus2000blkgrp") to get started.\n')
